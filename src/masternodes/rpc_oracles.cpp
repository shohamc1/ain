...
UniValue appointoracle(const JSONRPCRequest &request) {
    ...
    RPCHelpMan{
        ...
        RPCExamples{
                          HelpExampleCli(
                "appointoracle", R"(mwSDMvn1Hoc8DsoB7AkLv7nxdrf5Ja4jsF '[{"currency": "USD", "token": "BTC"}, {"currency": "EUR", "token":"ETH"}]' 20)") +
            HelpExampleRpc(
                "appointoracle", R"(mwSDMvn1Hoc8DsoB7AkLv7nxdrf5Ja4jsF '[{"currency": "USD", "token": "BTC"}, {"currency": "EUR", "token":"ETH"}]' 20)")},
    }
        .Check(request);
...
UniValue updateoracle(const JSONRPCRequest &request) {
    ...
    RPCHelpMan{
        ...
        RPCExamples{
                          HelpExampleCli(
                "updateoracle", R"(84b22eee1964768304e624c416f29a91d78a01dc5e8e12db26bdac0670c67bb2 mwSDMvn1Hoc8DsoB7AkLv7nxdrf5Ja4jsF '[{"currency": "USD", "token": "BTC"}, {"currency": "EUR", "token":"ETH"]}' 20)") +
            HelpExampleRpc(
                "updateoracle", R"(84b22eee1964768304e624c416f29a91d78a01dc5e8e12db26bdac0670c67bb2 mwSDMvn1Hoc8DsoB7AkLv7nxdrf5Ja4jsF '[{"currency": "USD", "token": "BTC"}, {"currency": "EUR", "token":"ETH"]}' 20)")},
    }
        .Check(request);
...
UniValue setoracledata(const JSONRPCRequest &request) {
    ...
    // decode prices
    const auto &prices = request.params[2];
    ...
    RPCHelpMan{
        ...
        RPCExamples{
          HelpExampleCli("listlatestrawprices", R"(listlatestrawprices '{"currency": "USD", "token": "BTC"}')") +
            HelpExampleCli(
                "listlatestrawprices", R"(listlatestrawprices '{"currency": "USD", "token": "BTC"}' '{"start": "b7ffdcef37be39018e8a6f846db1220b3558fd649393e9a12f935007ef3bfb8e", "including_start": true, "limit": 100}')") +
